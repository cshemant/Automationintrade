...
def main():
    ...
    payload = {
        ...
        "sourceNote": "Generated by GenerateStockResearchIndex.py from market-data and pre-generated JSON outputs. HTML cards render from JSON; images are optional legacy references.",
        "tools": [
